...
create table user_on (				
	...
	u_nick	varchar2(50)	 not null,		-- 닉네임
...
insert into user_on values('user01', '01012345678', 'user01@mail.com', '1111', 'usernick01', 0, 'A', 'address01', to_date('2022/11/15 17:10:44', 'YYYY/MM/DD HH24:MI:SS'), 'B', default);
